...
public class ViewTourActivity extends AppCompatActivity {
    ...
    public void showCongratulations(View view){
        ...
        tour.clear();
        congratulationIntent.putExtra("pubs",
                getIntent().getParcelableArrayListExtra("pubs"));
        congratulationIntent.putExtra("all_pubs",
                getIntent().getParcelableArrayListExtra("all_pubs"));
        congratulationIntent.putExtra("town_name",
                getIntent().getStringExtra("town_name"));
        congratulationIntent.putExtra("pub_crawl", tour);
        congratulationIntent.putExtra("is_crawl", 0);
        congratulationIntent.putExtra("time_mins",
                getIntent().getIntExtra("time_mins", 0));
        congratulationIntent.putExtra("interval",
    ...
    public void goHome(View view){
        ...
        homeIntent.putExtra("time_mins", timeMins);
        homeIntent.putExtra("interval", interval);
